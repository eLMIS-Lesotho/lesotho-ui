...
(function() {
    ...
    function routes($stateProvider, REQUISITION_RIGHTS, FULFILLMENT_RIGHTS) {
        ...
        $stateProvider.state('openlmis.requisitions.acknowledge', {
            showInNavigation: true,
            label: 'Acknowledge Requisition',
            url: '/requisition-acknowledge',
            //url: '^/requisition/:rnr',
            controller: 'RequisitionViewController',
            controllerAs: 'vm',
            templateUrl: 'stock-adjustment/stock-adjustment.html',
            //templateUrl: 'requisition-acknowledge/requisition-acknowledge.html',
            isOffline: true,
            accessRights: [
